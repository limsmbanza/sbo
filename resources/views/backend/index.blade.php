          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="pages/icons/mdi.html">
                ...
                <i class="mdi mdi-contacts menu-icon" style="color:#fff;"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="pages/forms/basic_elements.html">
                <span class="menu-title" style="color:#fff;">Forms</span>
                <i class="mdi mdi-format-list-bulleted menu-icon" style="color:#fff;"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="pages/charts/chartjs.html">
                <span class="menu-title" style="color:#fff;">Charts</span>
                <i class="mdi mdi-chart-bar menu-icon" style="color:#fff;"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="pages/tables/basic-table.html">
                <span class="menu-title" style="color:#fff;">Tables</span>
                <i class="mdi mdi-table-large menu-icon" style="color:#fff;"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#general-pages" aria-expanded="false" aria-controls="general-pages">
                <span class="menu-title" style="color:#fff;">Sample Pages</span>
                <i class="menu-arrow"></i>
                <i class="mdi mdi-medical-bag menu-icon" style="color:#fff;"></i>
              </a>
          ...
          <div class="content-wrapper" style="background:#fff;">
            ...
            <div class="page-header">
              <h3 class="page-title">
                ...
                </span style="color:#fff;"> Tableau de bord </h3>
            ...
            <div class="row">
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    <img src="{{ asset('css/backend/assets/images/dashboard/circle.svg') }}" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Site d'exploitation <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                    </h4>
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    <img src="{{ asset('css/backend/assets/images/dashboard/circle.svg') }}" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Agents <i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                    </h4>
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body">
                    <img src="{{ asset('css/backend/assets/images/dashboard/circle.svg') }}" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Utilisateurs connectés<i class="mdi mdi-diamond mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5">0</h2>
